           ...
           <section className="hero is-small my-2 is-bold">
                <div className="hero-body">
                    <div className="column">
                        ...
                        <div className="column is-flex-fullhd is-flex-desktop is-justified-center is-align-items-center">
                            <div className="is-bold mb-2 column is-flex-mobile is-flex-tablet">
                                <figure>
                                    <img src="https://img.etimg.com/thumb/width-1200,height-900,imgsize-226741,resizemode-75,msid-64333030/magazines/panache/indra-nooyi-highest-paid-female-ceo-fewer-women-bosses-worldwide-but-their-pay-higher-than-men.jpg" alt="ceo image" className="is-64x64 is-rounded" />
                                   
                                </figure>
                            </div>
                            <div className="column is-fullwidth-mobile">
                                    <p className="column is-size-6 is-family-code">
